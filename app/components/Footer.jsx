      ...
      <div className="container mx-auto mb-24">
        ...
        >
          <div className="flex flex-col flex-1 gap-y-8">
            ...
            <div className="text-secondary">No 1, car rental company</div>
          ...
          <div className="flex-1">
            <h3 className="h3 font-bold mb-8">Newslatter</h3>
            <div className="mb-9 text-secondary">Subscribe us!</div>
